...
class Pembagiantb extends \Phalcon\Mvc\Model
{
     ...
     * @Primary
     * @Identity
     * @Column(column="id_pembagiantb", type="integer", length=3, nullable=false)
     */
    public $id_pembagiantb;
     ...
     * @return Pembagiantb[]|Pembagiantb|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Pembagiantb|\Phalcon\Mvc\Model\ResultInterface
     */
